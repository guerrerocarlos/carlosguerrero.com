...
window.onload = function() {
 ...
 var githubicon = `<img style="width: 30px;margin-right: 10px;" src="./images/github-60.png">`
 var twittericon = `<img style="width: 30px;margin-right: 10px;" src="./images/twitter-60.png">`
